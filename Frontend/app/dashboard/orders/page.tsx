...
import { ArrowLeft, ClipboardList, Clock, Wifi } from "lucide-react"
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8">
        <div className="text-center space-y-4">
          <div className="w-24 h-24 sm:w-20 sm:h-20 rounded-full bg-muted mx-auto flex items-center justify-center">
            <ClipboardList className="h-12 w-12 sm:h-10 sm:w-10 text-muted-foreground" />
          </div>
          <h2 className="text-2xl sm:text-xl font-bold text-foreground">Order Management</h2>
          <p className="text-base sm:text-sm text-muted-foreground max-w-md px-4">
            This is where you will track and process customer orders.
          </p>
        </div>
      </main>
